package com.gradledevextreme.light.indooratlaspro.View.Activities.ImageView;
...
import com.gradledevextreme.light.indooratlaspro.View.CustomView.BlueDotView;
import com.gradledevextreme.light.indooratlaspro.R;
import com.gradledevextreme.light.indooratlaspro.Util.ExampleUtils;
...
/*
Activity to show floor map and blue dot that depicts current location of user
 */
public class ImageViewActivity extends FragmentActivity {
    ...
    private BroadcastReceiver onComplete = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (id != mDownloadId) {
                Log.w(Constants.TAG, "Ignore unrelated download");
                return;
            }
            Log.w(Constants.TAG, "Image download completed");
    ...
    private void showFloorPlanImage(String filePath) {
        Log.w(Constants.TAG, "showFloorPlanImage: " + filePath);
        mImageView.setRadius(mFloorPlan.getMetersToPixels() * Constants.dotRadius);
        ...
        if (mPendingAsyncResult != null) {
            mPendingAsyncResult.setCallback(new IAResultCallback<IAFloorPlan>() {
                ...
                public void onResult(IAResult<IAFloorPlan> result) {
                    Log.d(Constants.TAG, "fetch floor plan result:" + result);
