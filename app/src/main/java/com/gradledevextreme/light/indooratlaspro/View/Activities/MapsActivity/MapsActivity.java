package com.gradledevextreme.light.indooratlaspro.View.Activities.MapsActivity;
...
/*
Maps Activity displaying google map used by wayfinding activities
 */
        ...
        if (mMarker == null) {
            if (mMap != null) {
                mMarker = mMap.addMarker(new MarkerOptions().position(latLng)
                        .icon(BitmapDescriptorFactory.defaultMarker(Constants.HUE_IABLUE)));
                mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(latLng, 25.0f));
            }
        } else {
