...
import com.gradledevextreme.light.indooratlaspro.Util.SdkExample;
...
/*
Base Wayfinding OverlayActivity
 */
@SdkExample(description = R.string.example_wayfinding_description)
public class WayfindingOverlayBaseActivity extends FragmentActivity implements LocationListener,
    ...
    private void showLocationCircle(LatLng center, double accuracyRadius) {
        ...
        Log.d("fatal", "showlocationcircle");
    }
    ...
    private IALocationListener mListener = new IALocationListenerSupport() {
        ...
        public void onLocationChanged(final IALocation location) {
            ...
            Log.d(Constants.TAG, "new location received with coordinates: " + location.getLatitude()
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        switch (requestCode) {
            case Constants.MY_PERMISSION_ACCESS_FINE_LOCATION: {
        ...
        Log.d("fatal", "onreqpermissionresult");
    }

    @Override
    public void onLocationChanged(Location location) {
        if (!mShowIndoorLocation) {
            Log.d(Constants.TAG, "new LocationService location received with coordinates: " + location.getLatitude()
                    + "," + location.getLongitude());

            showLocationCircle(
                    new LatLng(location.getLatitude(), location.getLongitude()),
                    location.getAccuracy());
            Log.d("fatal", "onLocationChanged");
        }
    }

    @Override
    public void onProviderDisabled(String provider) {
        Log.d("fatal", "providerdisabled");
    }

    @Override
    public void onProviderEnabled(String provider) {
        Log.d("fatal", "providerenabled");
    }

    @Override
    public void onStatusChanged(String provider, int status, Bundle extras) {
        Log.d("fatal", "onstatuschnaged");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(this, ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, Constants.MY_PERMISSION_ACCESS_FINE_LOCATION);
            return;
        }
        ...
        if (graphJSON == null) {
            Toast.makeText(this, "Could not find wayfinding_graph from raw " +
    ...
    public void setupGroundOverlay(IAFloorPlan floorPlan, Bitmap bitmap) {
        ...
        Log.d("fatal", "setupgroundoverlay");
        //12.924720744232033
        //77.68175695091486
    ...
    private void fetchFloorPlanBitmap(final IAFloorPlan floorPlan) {
        ...
        if (mLoadTarget == null) {
            mLoadTarget = new Target() {
                ...
                public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                    Log.d(Constants.TAG, "onBitmap loaded with dimensions: " + bitmap.getWidth() + "x"
                            + bitmap.getHeight());
            ...
            Log.d("fatal", "fetchfloormapbitmap");
        }
        ...
        if (bitmapHeight > Constants.MAX_DIMENSION) {
            request.resize(0, Constants.MAX_DIMENSION);
        } else if (bitmapWidth > Constants.MAX_DIMENSION) {
            request.resize(Constants.MAX_DIMENSION, 0);
        }
    ...
    private void cancelPendingNetworkCalls() {
        ...
        Log.d("fatal", "cancelPendingNetworkCalls");
    }
    ...
    private void startListeningPlatformLocations() {
        ...
        Log.d("fatal", "startListerningplatformlocations");
    }


    private String loadGraphJSON() {
        try {
            Log.d("fatal", "loadGraphJson");
            ...
            Log.e(Constants.TAG, "Could not find wayfinding_graph.json from raw resources folder");
            return null;
        }
    ...
    public void onMapClick(LatLng point) {
        ...
        if (mMap != null) {
            ...
            Log.d(Constants.TAG, "Set destination: (" + mDestination.latitude + ", " +
    ...
    private void updateRoute() {
        ...
        Log.d(Constants.TAG, "Updating the wayfinding route");


        mCurrentRoute = mWayfinder.getRoute();

        for (int i = 0; i < mCurrentRoute.length; i++) {
            Log.d("route", String.valueOf(mCurrentRoute[i].getBegin().getLatitude()));
            Log.d("route", String.valueOf(mCurrentRoute[i].getBegin().getLongitude()));
     ...
     */
    public void visualizeRoute(IARoutingLeg[] legs) {
        ...
        Log.d("fatal", "visualisepath");
    }

    @Override
    public void onMapReady(GoogleMap googleMap) {
        Log.d("fatal", "onMapReady");
    }
